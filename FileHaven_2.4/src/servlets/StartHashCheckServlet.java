...
/**
 * Servlet implementation class StartHashCheckServlet
 */
public class StartHashCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StartHashCheckServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("HashCheck",file);
		getServletContext().getRequestDispatcher("/HashCheck.jsp").forward(request,response);
		}
		catch(Exception ex){
			fdb.remove();
